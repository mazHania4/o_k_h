<?php
    ...
    $posts = (isset($_SESSION['searched_posts'])) ? unserialize($_SESSION['searched_posts']) : []; 
    unset($_SESSION['searched_posts']);
?>

<div class="container">
    
    <!-- Formulario de búsqueda de publicaciones -->
    <div class="m-4">
        <form id="searchForm" action="/o_k_h/ctrl/search.php" method="GET" class="row g-3">
            <div class="col-md-4">
                <label for="searchTerm" class="form-label">Publicador, Título o Descripción</label>
                <input type="text" class="form-control" id="searchTerm" name="searchTerm" placeholder="Buscar por nombre, título o descripción">
            </div>
            <div class="col-md-2">
